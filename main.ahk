...
; disabling for now as I have media keys for this
; gonna bring it back once I write the UI wrapper and ability to remap hotkeys
; if anyone's reading this -> sorry :)
; CapsLock::
;     ; Send, {CapsLock}
;     gosub PlayStop
;     return
